    ...
    (function() {
        ...
        $(document).ready(function(){
            $(window).scroll(function(){
                ...
                var wm=document.getElementById('section2').offsetLeft/2;
                var wm2=document.getElementById('section4').offsetLeft
                if(ws>=wm){
                ...
                if(ws>=document.getElementById('section5').offsetLeft-1000){
                    $('#logo img').attr("src","img/logo5.png");
                    $('header p').css({color:"#fff"})
                }else{
                    $('header p').css({color:"#000",fontWeight:"bold"})
                }
                if(ws>=wm+4100){
            ...
            $('#up_btn').click(function(){     
                $('html').stop().animate({scrollLeft:0},'slow')
            });
            $('.fix_button').mouseover(function(){
                $(this).hide();
